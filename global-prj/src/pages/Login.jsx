...
import Alert from '../components/common/Alert'; // Corrected path based on project structure
...
export default function Login() {
  const [formData, setFormData] = useState({
    email: 'eve.holt@reqres.in', // Corrected to Reqres API email
    password: 'cityslicka' // Corrected to Reqres API password
  });
